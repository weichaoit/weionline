...
class UserProfile(AbstractUser):
    ...
    image = models.ImageField(upload_to='image/%Y/%m/%d',default='image/default.png',max_length=150)
...
class Banner(models.Model):
    ...
    image = models.ImageField(upload_to='banner/%Y/%m/%d',verbose_name='轮播图',max_length=150)
